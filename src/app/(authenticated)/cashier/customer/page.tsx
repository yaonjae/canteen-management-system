...
const Customer = () => {
    ...
    const handleEdit = (id: string) => {
        router.push(`/cashier/add-customer?id=${id}`);
    };
            ...
            <Card>
                ...
                <CardContent className='space-y-4'>
                    <div className='flex justify-between items-center'>
                        ...
                        <Button onClick={() => router.push('/cashier/add-customer')}>ADD</Button>
                    </div>
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                filteredCustomer?.map((customer) => (
                                    <TableRow key={customer.id}>
                                        ...
                                        <TableCell className='flex gap-4'>
                                            <ShoppingCart size={15} onClick={() => router.push(`/cashier/view-customer?id=${customer.id}`)} />
