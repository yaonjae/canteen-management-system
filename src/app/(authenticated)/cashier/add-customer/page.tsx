...
export default function AddCustomer() {
    ...
    return (
        <Card className="max-w-3xl mx-auto mt-5 py-5">
            <CardHeader>
            ...
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        />
                        <Button variant='outline' type="button" onClick={() => router.push('/cashier/customer')}>Cancel</Button>&nbsp;
